...
class InAppWebViewSettings {
  ...
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android native WebView ([Official API - View.setScrollBarSize](https://developer.android.com/reference/android/view/View#setScrollBarSize(int)))
  int? scrollBarSize;
  ...
  static InAppWebViewSettings? fromMap(Map<String, dynamic>? map) {
    ...
    final instance = InAppWebViewSettings(
      ...
      scrollBarSize: map['scrollBarSize'],
