...
public class PullToRefreshLayout extends SwipeRefreshLayout implements Disposable {
  ...
  public void setIndicator() {
    try {
      ...
      ImageView imgVW = (ImageView) f.get(this);
      lottieDrawable.setBounds(0, 0, 64, 64);
      @SuppressLint("WrongThread") LottieResult<LottieComposition> result = LottieCompositionFactory.fromRawResSync(getContext(), R.raw.loadingicon_1);
      lottieDrawable.setComposition(result.getValue());
      lottieDrawable.setRepeatCount(LottieDrawable.INFINITE);
      imgVW.setImageDrawable(lottieDrawable);
      imgVW.setPadding(15, 15, 15, 15);
      lottieDrawable.playAnimation();
    } catch (Exception e) {
      e.printStackTrace();
      Log.e(LOG_TAG, "setIndicator", e);
    }
  }
